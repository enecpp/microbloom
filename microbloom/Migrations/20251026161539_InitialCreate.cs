    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "ASP.NET Core ve Azure konusunda deneyimli...", true, "İstanbul", new DateTime(2025, 10, 26, 16, 15, 38, 838, DateTimeKind.Utc).AddTicks(5068), "Kıdemli .NET Geliştiricisi" },
                    { 2, 1, "React ve TypeScript bilen...", true, "Ankara", new DateTime(2025, 10, 26, 16, 15, 38, 838, DateTimeKind.Utc).AddTicks(5070), "Frontend Geliştirici (React)" },
                    { 3, 2, "CI/CD süreçlerine hakim...", true, "İstanbul", new DateTime(2025, 10, 26, 16, 15, 38, 838, DateTimeKind.Utc).AddTicks(5070), "DevOps Mühendisi" }
                });
